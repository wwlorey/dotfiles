...
- **Post-commit push prompt** — after every commit, ask the user "Push to origin?" rather than waiting for them to bring it up. Do not push without an explicit yes. Unless explicitly told otherwise in your prompt.
